...
export default function FeaturesSection() {
  ...
  const target = 541; // target number
  const duration = 5000; // 2 seconds animation
    ...
    <section className="px-4 py-16 md:py-32">
      <div className="mx-auto grid max-w-5xl border md:grid-cols-2">
          ...
          <div aria-hidden className="flex flex-col gap-8">
            ...
            <div>
              <div className="rounded-(--radius) mb-1 ml-auto w-3/5 bg-blue-600 p-3 text-xs text-white">
                We never fail to provide complete and reliable solutions for
                your needs.
              </div>
        ...
        <div className="col-span-full border-y p-12">
          <p className="text-center text-2xl font-semibold lg:text-7xl">
            {count}+ active Users
          </p>
        </div>
...
const chartData = [
  { month: "May", desktop: 56, mobile: 500 },
  { month: "June", desktop: 56, mobile: 654 },
  { month: "January", desktop: 126, mobile: 476 },
